...
from helper import load_input, save_data
...
def do_orga(formats=('csv', )):
    ...
    # Map the links of the loaded data to the attributes of the learn-pages:
    mapped_links = []
    ...
    # Concat the data with the pages attributes
    ...
    print("Orga finished, generated ROOT/data/data_clean.csv")
