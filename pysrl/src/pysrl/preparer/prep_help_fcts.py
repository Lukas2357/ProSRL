...
def add_regression(x_line: np.array, x_marker: np.array, y_line: np.array,
    ...
    Args:
        x_line (np.array): x data to plot as line
        x_marker (np.array): x data to plot with markers
        y_line (np.array): y data to plot as line
        y_marker (np.array): y data to plot with markers
        ...
        prev_range_data (np.array): Previous mean data of different ranges
        x_ranges (np.array): Borders of different ranges
        y_ranges (np.array): Mean data of different ranges
