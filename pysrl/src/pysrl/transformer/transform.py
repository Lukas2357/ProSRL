"""Transformer for data after organization and prior to preparation"""
...
def do_trafo(formats=('csv', )):
    ...
    # Load the cleaned up data from data_clean.csv
    ...
    print("Finished transformation, generated ROOT/data/data_trafo.csv")
