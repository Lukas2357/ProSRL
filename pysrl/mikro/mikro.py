...
from get_data import generate_data_tests, load_micro_tests
...
# ---- Ergänzungen für die Micro Auswertung ------------------------------------
# Mögliche Feature (vgl. features.txt), die in an.features am besten
# über ihren Namen ausgewählt werden können:

# ['PrevAct', 'Test', 'TestResQual', 'NextAct']

# um die Micro Auswertung auszuwählen, müssen folgende Änderungen
# vorgenommen werden:

# Für die Tests:
# an.use_micro_tests = True

# Für die Exercises:
# an.use_micro_exercise = True
...
an.features = ['PrevAct', 'NextAct', 'Test', 'TestResQual']
...
an.clear_recent = False  # Lösche temporären Ergebnisordner vor Analyse
